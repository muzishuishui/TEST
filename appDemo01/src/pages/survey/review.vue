	...
	<div class="review">
		<el-row class="topBtns">
			...
			<el-col :span='12' class="content-right">
				...
				<el-button @click='toAddReview'>添加</el-button>
			  ...
			  <el-table
			    ...
			    <el-table-column
			     ...
			     <template slot-scope='scope'> 
				     ...
				     <el-button type='text' @click='toEditReview(scope.row)'>查看进度</el-button>
				     <el-button type='text' @click='toDeleteReview(scope.row)'>结束</el-button>
			     </template>
			    </el-table-column>
			  </el-table>
			</el-col>
	...
	export default{
		...
		methods:{
			...
			toAddReview(row){
				// //初始化
				this.resetForm();
				// this.$refs['reviewDialogForm'].resetFields();
				//1.弹出模态框
				this.reviewDialog.title = '添加年纪信息'
			...
			//去修改年级数据
    	 	toEditReview(row){
    	 		this.reviewDialog.title = '修改年纪信息'
				this.reviewDialog.visible =true;

				this.reviewDialog.form = row;
    	 	...
    	 	submitReviewForm(){
    	 		//0.数据校验
    	 		this.$refs['reviewDialogForm'].validate((valid)=>{
    	 			if(valid){
    	 			  //1.向后台发送数据
		    	 		let review = this.reviewDialog.form;
